...
from datasets import TestCLoader
...
def test_c(module, dataloader, opt):
    ...
    # encoding_array = encoding_array.reshape(encoding_array.shape[0], encoding_array.shape[1] * encoding_array.shape[2] * encoding_array.shape[3]) # for densenet
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', default='covid2', type=str, help='Choose the dataset name for save results')
    parser.add_argument('--num_classes', default=1, type=int, help='Number of classes for classification')
    parser.add_argument('--gpu_ids', type=str, default='0')
    parser.add_argument('--classifier', type=str, default='checkpoints/covid2/convnext_tiny/convnext_tiny_best_netC.pth', help='classifier checkpoint file')
