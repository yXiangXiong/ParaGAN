...
def define_model_trunc(project_name, model):
    model_trunc = None
    if project_name == 'cyclegan_resnet18' or project_name == 'cyclegan_resnet34' or project_name == 'cyclegan_resnet50' or project_name == 'resnet101':
    ...
    if project_name == 'cyclegan_inception_v3':
        model = model.module
        model_trunc = create_feature_extractor(model, return_nodes = {'avgpool': 'semantic_feature'})
    if project_name == 'cyclegan_efficientnet_b5' or project_name == 'cyclegan_efficientnet_b4':
        model = model.module
        model_trunc = create_feature_extractor(model, return_nodes = {'avgpool': 'semantic_feature'})
